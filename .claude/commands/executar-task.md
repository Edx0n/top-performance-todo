...
### 5. Validação com Playwright MCP (Obrigatório para bugs visuais/frontend se possivel)
...
<critical>Utilize o Context7 MCP se possivel para analisar a documentação da linguagem, frameworks e bibliotecas envolvidas na correção</critical>
