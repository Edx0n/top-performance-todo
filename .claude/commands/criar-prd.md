...
<critical>NÃO GERE O PRD SEM ANTES FAZER PERGUNTAS DE CLARIFICAÇÃO (USE A SUA ASK USER QUESTIONS TOOL)</critical>
<critical>EM HIPOTESE NENHUMA, FUJA DO PADRÃO DO TEMPLATE DO PRD</critical>
<critical>NÃO GERE NENHUM CODIGO</critical>
## Objetivos
...
- Template fonte: @.cursor/exampleTemplates/prd-template.md
