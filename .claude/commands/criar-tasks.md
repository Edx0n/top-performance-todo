...
- Template para a lista de tarefas: @.cursor/exampleTemplates/tasks-template.md
- Lista de tarefas: `./tasks/prd-[nome-funcionalidade]/tasks.md`
- Template para cada tarefa individual: @.cursor/exampleTemplates/task-template.md
- Tarefas individuais: `./tasks/prd-[nome-funcionalidade]/[num]_task.md`

### Formato do Resumo de Tarefas (tasks.md)

- **SEGUIR ESTRITAMENTE O TEMPLATE EM @.cursor/exampleTemplates/tasks-template.md**

### Formato de Tarefa Individual ([num]_task.md)

- **SEGUIR ESTRITAMENTE O TEMPLATE EM @.cursor/exampleTemplates/task-template.md**
